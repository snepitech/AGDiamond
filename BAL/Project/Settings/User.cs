...
namespace BAL.Project.Settings
{
    public class User
    {
        ...
        private static string mStrRole = "User_Mast";
        public static dynamic Select(BAL.DataAccessLayer.User_Mast _ac, BAL.FilterSetting _f)
        {
            try
            {
                ...
                SqlOps.AddParams(_HT, "role_id", _ac.role_id);
                ...
                SqlOps.FillDataSet(SqlOps.EnumServer.NewWorkSoft, _DS, mStrRole, StoredProcedures.spUser, SqlOps.GetParams(_HT), "");
